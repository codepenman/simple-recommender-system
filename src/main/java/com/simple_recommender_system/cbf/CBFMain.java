package com.simple_recommender_system.cbf;
...
import com.simple_recommender_system.cbf.dao.*;
...
public class CBFMain {
    ...
    private static LenskitConfiguration configureRecommender() {
        ...
        config.set(RatingFile.class)
              .to(new File("resources/data_sets/PreprocessedDataForMahout.csv"));
        ...
        config.set(TagFile.class)
              .to(new File("resources/data_sets/movie-tags.csv"));
        // and title file
        config.set(TitleFile.class)
              .to(new File("resources/data_sets/movieid-movie.csv"));

        // our user DAO can look up by user name
        config.bind(UserDAO.class)
              .to(MOOCUserDAO.class);
        config.set(UserFile.class)
              .to(new File("resources/data_sets/users.csv"));
